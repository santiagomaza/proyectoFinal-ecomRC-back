    ...
    try {
      ...
      await transporter.sendMail({
        ...
        `
          ...
          <a href="https://ecom-rc.vercel.app/verificar-email/${idUsuario}">https://ecom-rc.vercel.app/verificar-email/${idUsuario}</a>
          <br>
          <br>
    ...
    try {
      await transporter.sendMail({
        ...
        `
          ...
          <br>
          <a href="https://ecom-rc.vercel.app/restablecerContraseña/${token_RC}">https://ecom-rc-front.vercel.app/restablecerContraseña/${token_RC}</a>
          <br>
          <br>
          <span>Saludos cordiales</span>
          <br>
