...
usuario.post("/crear-usuario", 
  ...
  body("contraseña").exists().trim().escape().isAlphanumeric("es-ES", {ignore:' '}).not().isEmpty().isLength({min: 8, max: 15}).isStrongPassword({minLength: 8, minLowercase: 1, minUppercase: 1, minNumbers: 1, minSymbols: 1 }).withMessage("Contraseña invalida"),
